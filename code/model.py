'''
This script was adapted from the original version by microsoft which is a part of https://github.com/microsoft/CodeXGLUE
'''
...
class DataFlowModel(nn.Module):
    """
        ...
        * `encoder`- encoder of GCB model. e.g. roberta
        * `decoder`- decoder of GCB model. e.g. transformer
...
class TokenModel(nn.Module):
    """
        ...
        Parameters:
        * `encoder`- encoder of TokenModel model. e.g. roberta
        * `decoder`- decoder of TokenModel model. e.g. transformer
        * `config`- configuration of encoder model. 
        * `beam_size`- beam size for beam search. 
        * `max_length`- max length of target for beam search. 
        * `sos_id`- start of symbol ids in target for beam search.
